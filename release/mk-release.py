...
VERIFICATION_ITEMS = [
    ...
    ("p1", "dpa_object_model_extension", "NOT_RUN", "remaining classes not started: interface/VLAN, tunnel, ACL/firewall, and the two QoS classes, which still report not_enumerable (no walker). vrf and nexthop-group are done."),
