...
VERIFICATION_ITEMS = [
    ...
    ("p1", "drift_event_correlation", "NOT_RUN", "not started -- correlating drift events to config commits, broker transactions, dataplane transactions and netlink events"),
