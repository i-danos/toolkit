...
VERIFICATION_ITEMS = [
    ...
    ("p1", "comparison_scope_mcast", "NOT_RUN", "mroute and mroute6 have a Desired source (show ip[v6] mroute json) and a topology that exercises them (TOPO=fw, verify-multicast-*.sh) but no comparison has been written or verified yet"),
