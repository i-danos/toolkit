...
VERIFICATION_ITEMS = [
    ...
    ("p2", "power_loss_recovery_boot_and_upgrade", "NOT_RUN", "no cut was placed during boot itself or during add-image/upgrade, and no real host power loss or disk-cache-ignoring hypervisor was tested"),
