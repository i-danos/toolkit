...
VERIFICATION_ITEMS = [
    ...
    ("p1", "drift_event_correlation_broker_dp_netlink", "NOT_RUN", "correlating drift events to broker transactions, dataplane transactions and netlink events -- not started; no equivalent already-logged, precisely-timestamped signal has been identified for these yet the way configd's commit log was found for config commits"),
